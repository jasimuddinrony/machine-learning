...
import CustomCss from './assets/scss/report.css'
import SurveyReport from "./pages/report/SurveyReport";
import SurveyReportDataList from "./pages/report/SurveyReportDataList";
import DetectImage from "./pages/ml/DetectImage";
...
const App = () => {
  return (
    <Router>
		<ScrollToTop>
			<Routes>
				<Route path={process.env.PUBLIC_URL + "/"} element={<DetectImage />}/>
				<Route path={process.env.PUBLIC_URL + "/report"} element={<SurveyReport />}/>
				<Route path={process.env.PUBLIC_URL + "/data-list/:asp"} element={<SurveyReportDataList />}/>
